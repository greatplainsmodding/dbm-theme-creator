        ...
        <div id="id_pages" style="padding: 12px 20px; width: 100%; height: 100%;">
            <div " style=" display: block;" class="page">
                <div class="action-holder">
                    <button id="createNewCommandOption" onclick="$('#createNewCommand').modal('show');" type="button" data-tooltip="Click to edit." data-position="top left" class="tiny ui labeled icon button" style="width: 200px;"><i
                            ...
                            Command</span></button>
                    <br><br>
                    <div class="myactions" style="width: 200px; height: 480px;">
                    </div>
                </div>
                <div id="command-content" style="margin-left: 250px; ">
                    <br>
                    <div>
                        <div style="float: left; width: 55%;">
                            <span id="comLabel"
                                onclick="$('#createNewCommand').modal({ centered: true }).modal('show');">Command
                                Name:</span><br>
                            <input id="name" style="width: 100%; height: 38px;" type="text">
                        </div>
                        <div style="float: right; width: 40%;">
                            <span id="commandtype">Command Type:</span><br>
                            <div style="width: 100%;">
                                <select class="ui fluid dropdown" id="comType">
                    ...
                    <br><br><br><br>
                    <span id="comRestriction">Command Restriction:</span><br>
                    <div style="width: 100%;">
                        <select class="ui fluid dropdown" data-tooltip="Add users to your feed" data-position="top left"
                            id="restriction">
                    ...
                    <br>
                    <span id="userrequiredpermission">User Required Permission:</span><br>
                    <select class="ui fluid dropdown" id="permissions" style="width: 100%;">
                    ...
                    <div class="footer">
                        <div class="infooter">
                            <div style="float: right; padding-bottom: 5px;">
                                <button class="tiny compact ui labeled icon button"><i class="plus icon"></i><span
                                        id="com_create">Create</span></button>
                                <button class="tiny compact ui labeled icon button"><i class="legal icon"></i><span
                                        id="com_edit">Edit</span></button>
                                <button class="tiny compact ui labeled icon button"><i class="remove icon"></i><span
                                        id="com_delete">Delete</span></button>
                            </div>
            ...
            <div id="Events" class="page">
                <div class="event-action-holder">
                    <button class="tiny ui labeled icon button" style="width: 200px;"><i class="plus icon"></i><span
                            id="createnewevent">Create New Event</span></button>
                    <br><br>
                ...
                <div id="event-command-content" style="margin-left: 250px; display: none;">
                    <br>
                    <span id="eventname">Event Name:</span><br>
                    <input id="ename" style="width: 100%; height: 38px;">
                    <br>
                    <span id="eventtrigger">Event Trigger:</span><br>
                    <select class="ui fluid dropdown" id="event-type" style="width: 100%;">
                        <option value="0" id="eventrig_none">None</option>
                        <option value="1" id="eventrig_botinit">Bot Initialization</option>
                        <option value="2" id="eventrig_anymsgsent">Any Message Sent (Deprecated: Use "Any Message"
                            command
                            type)</option>
                    ...
                    <div id="tempVarStore">
                        ...
                        <input id="etemp" style="width: 100%;" type="text">
                    </div>
                    <br>
                    <div id="tempVarStore2" style="position: absolute;">
                        <span id="tempLabel2"></span>
                        <input id="etemp2" style="width: 100%;" type="text">
                    </div>
                    <div class="footer">
                        <div class="einfooter">
                            <div style="float: right; padding-bottom: 5px;">
                                <button class="tiny compact ui labeled icon button"><i class="plus icon"></i><span
                                        id="eve_create">Create</span></button>
                                <button class="tiny compact ui labeled icon button"><i class="legal icon"></i><span
                                        id="eve_edit">Edit</span></button>
                                <button class="tiny compact ui labeled icon button"><i class="remove icon"></i><span
                                        id="eve_delete">Delete</span></button>
                            </div>
            ...
            <div id="Settings" class="page" style="padding-top: 20px;">
                <div class="ui piled segment">
                    ...
                    <p id="settings-description"><span id="startdescsettings">Use this page to register all of your
                            bot's
                            information and connect it to your project! If you have not created a bot account yet, you
                            may
                            do so by visiting </span><a href="#"
                            onclick="DBM.openLink('https://discordapp.com/developers/applications/me')"
                            id="discorddevpage">Discord's developer page</a><span id="enddescsettings">. One may also
                            customize the data encryption password and other various properties pertaining to the
                            bot.</span></p>
                </div>
                <div style="width: 85%; display: table;">
                    <div style="display: table-cell; padding-right: 5%;">
                        <span id="commandtag">Command Tag:</span><br>
                        <input class="settings" type="text" id="settings-tag">
                    </div>
                    <div style="display: table-cell; padding-right: 5%;">
                        <span id="parameterseparator">Parameter Separator:</span><br>
                        <input class="settings" type="text" id="settings-separator">
                    </div>
                    <div style="display: table-cell;">
                        <span id="commandcasesensitive">Command Case Sensitive:</span><br>
                        <select class="settings round" id="settings-case">
                ...
                <div style="width: 85%; display: table;">
                    <div style="display: table-cell; padding-right: 5%;">
                        ...
                        <input class="settings" type="text" id="settings-ownerId">
                    </div>
                    <div style="display: table-cell;">
                        <span id="encryptionpass">Encryption Password:</span><br>
                        <input class="settings" type="text" id="settings-encrypt" placeholder="Leave blank to disallow...">
                    </div>
                </div>
                <br>
                <span id="bottoken">Bot Token:</span><br>
                <div style="float:left; width: 85%;">
                    <input class="settings" type="password" autocomplete="new-password" id="settings-token">
                </div>
                <div style="float:left; padding-left: 20px;"><button class="tiny compact ui icon button"
                        style="width: 50px;" id="showbutton">Show</button></div>
                <br><br>
                <div style="padding-top: 6px;"><span id="clientid">Client ID:</span></div>
                <input class="settings" style="width: 85%;" type="text" id="settings-client" maxlength="18"><br>
                <p id="bot-links">
                </p>
            </div>
        </div>
            ...
            <div style="text-align: center; padding-top: 5%;">
                ...
                <div id="saveAndQuit" class="ui basic modal" style="background-color: #36393e; border: 2px solid black;">
                    ...
                    <div style="text-align: center; padding-bottom: 5%;">
                        <button class="tiny compact ui labeled icon button">
                            <i class="checkmark icon"></i>
                            <span id="savebutton">Save</span>
                        </button>
                        <button class="tiny compact ui labeled icon button" style="margin-left: 20px;">
                ...
                <div id="aliases" class="ui small modal">
                    ...
                    <div>
                        <div style="width: 85%; margin-left: 45px; margin-top: 15px;" class="ui icon input">
                            <input style="height: 38px;" id="alias-input" type="text" placeholder="Add alias...">
                            <i class="inverted circular plus link icon" onclick="DBM.addAlias()"></i>
                        </div>
                    </div>
                </div>
                <div id="cooldown" class="ui small modal"
                    style="height: 180px; border-radius: 10px; background-color: #36393e; border: 2px solid black;">
                    <h5 style="text-align: center;" class="ui header"><span id="text-cooldown">Command Aliases</span>
                    </h5>
                    <div style="margin: 20px 20px 20px 20px">
                        <div style="float: left; width: 45%;">
                            <span id="amountoftime">Amount of Time:</span><br>
                            <input class="round" style="height: 38px; margin-top: 5px;" id="cooldown-input" type="text">
                        </div>
                        <div style="float: right; width: 45%;">
                            <span id="timemeasurement">Time Measurement:</span><br>
                            <div style="margin-top: 5px;">
                                <select class="ui fluid dropdown" id="select-cooldown" style="width: 100%;">
                ...
                <div id="moduleManager" class="ui modal">
                    <h5 style="text-align: center;" class="ui header"><span id="nodejsmodules">NodeJS Modules</span>
                    </h5>
                    ...
                    <div>
                        <div style="width: 85%; margin-left: 45px; margin-top: 15px;" class="ui icon input">
                            <input style="height: 38px;" id="mm-input" type="text" placeholder="Add module...">
                            <i class="inverted circular plus link icon"></i>
                        </div>
                    </div>
                </div>
                ...
                <!--</div>-->
                <link rel="stylesheet" type="text/css" id="maintheme" href="../css/main.css">
            </div>
        </div>
    </body>
        `
